...
import { Music, Palette, Trophy, Globe, Heart, ArrowRight, Star } from "lucide-react"
...
const activityCategories = [
  {
    ...
    image: "/traditional-dress-group.jpeg",
  ...
  },
  {
    ...
    color: "var(--school-gold-dark)",
    bgColor: "var(--school-gold-light)",
    image: "/Mother's day activity.png",
    description: "A special day dedicated to honoring the incredible mothers of our students. Through creative card-making, emotional storytelling, and interactive workshops, we celebrate the bond of love and gratitude. It's a day where students express their deepest appreciation through art and performance, fostering family bonds and emotional intelligence.",
    activities: ["Creative Card Making", "Poetry Recitation", "Storytelling Sessions", "Gift Crafting", "Emotional Intelligence", "Family Bonding Workshops"],
  },
]
const galleryImages = [
