...
const galleryImages = [
  ...
  { src: "/stage-performance-1.jpeg", alt: "Patriotic performance by students" },
  { src: "/principal-speech.jpeg", alt: "Chairman Sir giving speech", position: "object-top" },
  { src: "/school-event-group.jpeg", alt: "Teachers with Chairman Sir" },
  { src: "/annual-function-audience.jpeg", alt: "Guest and audience at school event" },
  { src: "/cultural-performance-2.jpeg", alt: "Punjabi cultural performance" },
  { src: "/dance-performance-white-theme.jpeg", alt: "Dramatic act by DCS students" },
  { src: "/group-dance-green.jpeg", alt: "Outfit for Haryanvi folk dance" },
