      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed inset-0 z-[105] lg:hidden bg-white flex flex-col"
          >
            {/* Background Pattern */}
            <div className="absolute inset-0 opacity-[0.03] pointer-events-none">
              <div className="absolute inset-0" style={{ backgroundImage: 'radial-gradient(var(--school-green) 1px, transparent 1px)', backgroundSize: '24px 24px' }}></div>
            </div>

            <div className="flex-1 overflow-y-auto px-6 pt-32 pb-10 relative z-10">
              <div className="flex flex-col gap-2">
                <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-[var(--school-green)]/40 mb-4 px-4">Navigation Menu</p>
                {navLinks.map((link, i) => {
                  const isActive = pathname === link.href
                  return (
                    <motion.div
                    ...
                    >
                      <Link
                        href={link.href}
                        className={cn(
                          "flex items-center justify-between px-5 py-4 rounded-2xl text-lg font-bold transition-all duration-300",
                          isActive
                            ? "bg-[var(--school-green)] text-white shadow-xl shadow-[var(--school-green)]/20"
                            : "text-[var(--school-green-dark)] hover:bg-[var(--school-green)]/5"
                        )}
                      >
                        {link.label}
                        <div className={cn(
                          "w-2 h-2 rounded-full transition-all duration-500",
                          isActive ? "bg-[var(--school-gold)] scale-150" : "bg-transparent"
                        )} />
                      </Link>
                    </motion.div>
                  )
              ...
              <div className="mt-12 pt-8 border-t border-[var(--school-green)]/10">
                <div className="grid grid-cols-1 gap-4">
                  ...
                  >
                    <Button asChild className="w-full h-14 rounded-2xl text-lg font-bold shadow-xl shadow-[var(--school-gold)]/20" style={{ backgroundColor: "var(--school-gold)", color: "var(--school-green-dark)" }}>
                ...
                <div className="mt-10 space-y-6">
                  <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-[var(--school-green)]/40 px-4">Get in touch</p>
                  <div className="space-y-4">
                    <a href="tel:+917532817306" className="flex items-center gap-4 px-4 text-[var(--school-green-dark)] font-medium hover:text-[var(--school-green)] transition-colors">
                      <div className="h-10 w-10 rounded-full bg-[var(--school-green)]/5 flex items-center justify-center">
                        <Phone className="h-5 w-5 text-[var(--school-green)]" />
                      </div>
                      +91 7532817306
                    </a>
                    <a href="mailto:daffodilsconventinformation@gmail.com" className="flex items-center gap-4 px-4 text-[var(--school-green-dark)] font-medium hover:text-[var(--school-green)] transition-colors">
                      <div className="h-10 w-10 rounded-full bg-[var(--school-green)]/5 flex items-center justify-center">
                        <Mail className="h-5 w-5 text-[var(--school-green)]" />
                      </div>
                      Email Us
                    </a>
                  </div>
